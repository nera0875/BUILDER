...
**PATH:** Scripts accessibles globalement (voir `bin/[command] --help`)
...
**STACK IMPOSÉE:** Next.js 16 + .stack/ (détails: `.stack/README.md`)
**RÈGLE:** TOUJOURS réutiliser .stack/ existant (dark mode, responsive, shadcn inclus)

**❌ NE JAMAIS demander:** Stack technique, design, CSS framework (imposés)

**✅ QUESTIONS AUTORISÉES (fonctionnelles uniquement):**

**OBLIGATOIRE: Utiliser AskUserQuestion tool**
...
**Questions:** Features fonctionnelles, Auth (oui/non), Database (PostgreSQL/JSON)
...
### PHASE 2: Création Projet (Automatique après validation)
